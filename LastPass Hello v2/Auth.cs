...
class GoogleAuth
{
    ...
    // Implementation of https://tools.ietf.org/html/rfc6238
        ...
        {
            get { return GoogleAuthenticator.Base32.ToString(Secret); }
            set { try { Secret = GoogleAuthenticator.Base32.ToBytes(value); } catch { }; OnPropertyChanged("SecretBase32"); }
        }
