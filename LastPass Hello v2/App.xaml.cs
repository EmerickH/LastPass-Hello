    ...
    sealed partial class App : Application
    {
        ...
        protected async override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if (await KeyCredentialManager.IsSupportedAsync())
            {
                ...
                KeyCredentialRetrievalResult result = await KeyCredentialManager.OpenAsync("LastPassCredentials");
                ...
                else
                {
                    KeyCredentialRetrievalResult creationResult =
                        await
                            KeyCredentialManager.RequestCreateAsync("LastPassCredentials",
            ...
            if (authorized == false)
            {
                ...
                erreur.Content = "Error: Can't connect with Windows";
                erreur.IsPrimaryButtonEnabled = true;
                erreur.PrimaryButtonText = "OK";
                erreur.ShowAsync();
            }
        }
